...
//            ArrayList<String> classes = (ArrayList<String>) database.getInstance().getListClass();
//            int a = classes.size();
//            for (int i = 0; i < a; i++) {
//                kelas.addItem(classes.get(i));
//            }
    ...
    private void loadTableData(String d, String s, String k){
        ...
        //isi tabel 
            for(attendance sub:
            database.getInstance().getAttendance(d,s,k)){
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(365, 130, 90, 30);
