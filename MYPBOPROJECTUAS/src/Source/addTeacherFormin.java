...
public class addTeacherFormin extends javax.swing.JInternalFrame {
    ...
    private void loadTableData(){
        ...
        try{
//            for(teacher sub:database.getInstance().getTeacherList()){
//                System.out.println("Teacher :"+sub.getTeacherid()+sub.getTeachername()+sub.getSubject().getSubjectname()+sub.getKelass());
//            }
        //isi tabel 
//               List<teacher> tea = database.getInstance().getTeacherList();
               List<teacher> teach = database.getInstance().getTeacherList();
               int j=0;
               //int k=tea.size();
               //System.out.println("k " +teach.size());
               int k =0;
...
//                            
                        ...
                        System.out.println("size " +teach.size());
